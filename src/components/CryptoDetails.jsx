...
import { useGetCryptoDetailsQuery, useGetCoinPriceHistoryQuery } from '../services/CryptoApi';
...
const CryptoDetails = () => {
    ...
    const stats = [
      ...
      { title: '24h Volume', value: `$ ${cryptoDetails?.marketCap && millify(cryptoDetails?.volume)}`, icon: <ThunderboltOutlined /> },
